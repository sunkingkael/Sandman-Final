...
# Fetch blob file
nnBlobPath = str((Path(__file__).parent / Path('../SandmanWorkspace/models/FYP-sandman-e300_openvino_2022.1_6shave.blob')).resolve().absolute())
...
spatialDetectionNetwork.setConfidenceThreshold(0.50)
...
# Data log and Message box toggle
log_flag = True
msg_flag = False
