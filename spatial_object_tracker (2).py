...
nnPathDefault = str((Path(__file__).parent / Path('../models/Final-e150_openvino_2022.1_6shave.blob')).resolve().absolute())
...
objectTracker.setDetectionLabelsToTrack([15,6,7])  # track only person
